...
module.exports = (app, validator) => {
    ...
    app.get('/api/reservation/:reservationId', loggedCheckMiddleware, validator.validate('get', '/reservation/{reservationId}'), (req, res, next) => {
    ...
    app.post('/api/reservation', loggedCheckMiddleware, validator.validate('post', '/reservation'), (req, res, next) => {
